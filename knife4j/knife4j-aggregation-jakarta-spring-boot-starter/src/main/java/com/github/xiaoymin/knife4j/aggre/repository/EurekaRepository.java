            ...
            if (serviceNames.contains(eurekaApplication.getName().toLowerCase()) && CollectionUtils.isNotEmpty(eurekaApplication.getInstance())) {
                ...
                if (instanceOptional.isPresent()) {
                    ...
                    Optional<EurekaRoute> eurekaRouteOptional =
                            eurekaSetting.getRoutes().stream().filter(eurekaRoute -> Objects.equals(eurekaRoute.getServiceName(), eurekaApplication.getName())
                                    || (eurekaRoute.getServiceName() != null && eurekaRoute.getServiceName().equalsIgnoreCase(eurekaApplication.getName()))).findFirst();

const enUS = {
  ...
  'json.collapseToFirstLevel': 'Collapse to first level',
  'apiDebug.response.expandAll': 'Expand all',
  'apiDebug.response.collapseToFirstLevel': 'Collapse to first level',
  'apiDebug.response.jsonViewer': 'JSON response content',

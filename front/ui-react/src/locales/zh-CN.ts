const zhCN = {
  ...
  'globalParam.scope': '作用于当前 OpenAPI 分组：{{group}}',
  'globalParam.currentGroup': '当前分组',
  'globalParam.scopeTip': '全局参数会用于当前分组的所有调试请求；接口调试页填写的同名参数优先。',
  'globalParam.empty': '当前分组还没有全局参数',
  ...
  'globalParam.btn.clear': '清除当前分组',
  'globalParam.source.manual': '手动输入',
  'globalParam.source.request': '请求获取',
  'globalParam.modal.add': '添加全局参数',
  'globalParam.modal.edit': '编辑全局参数',
  'globalParam.confirm.delete': '确定删除这个全局参数吗？',
  'globalParam.confirm.clear': '确定清除当前分组的全部全局参数和 Cookie 会话配置吗？',
  'globalParam.msg.saved': '全局参数已保存',

const jaJP = {
  ...
  'json.viewer': 'JSON 内容',
  'json.expandAll': 'すべて展開',
  'json.collapseToFirstLevel': '第1階層まで折りたたむ',
  'apiDebug.response.expandAll': 'すべて展開',
  'apiDebug.response.collapseToFirstLevel': '第1階層まで折りたたむ',
  'apiDebug.response.jsonViewer': 'JSON レスポンス内容',

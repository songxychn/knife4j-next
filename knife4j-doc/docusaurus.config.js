...
module.exports = {
  title: "Knife4j Next",
  tagline: "Knife4j 社区维护分支的文档与迁移说明.",
  url: "https://doc.xiaominfo.com",
  baseUrl: "/",
  trailingSlash: false,
  organizationName: "songxychn",
  projectName: "knife4j-next",
  scripts: [
    "/js/custom.js",
    "/js/baidu.js",
    // , {
  ...
  customFields: {
    ...
    gaGtag: true,
    repoUrl: "https://github.com/songxychn/knife4j-next",
  },
    ...
    /** @type {import('@docusaurus/preset-classic').ThemeConfig} */ ({
      ...
      navbar: {
        ...
        items: [
          ...
          {
            href: "https://github.com/songxychn/knife4j-next",
            label: "GitHub",
          ...
          },
          {
            ...
            items: [
              ...
              },
              {
                ...
                href: "https://github.com/songxychn/knife4j-next/releases",
              },
              {
                label: "spring中文文档",

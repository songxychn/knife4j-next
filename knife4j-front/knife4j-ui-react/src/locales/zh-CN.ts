const zhCN = {
  ...
  'apiDebug.history.title': '发送历史',
  'apiDebug.history.expand': '展开发送历史',
  'apiDebug.history.collapse': '折叠发送历史',
  'apiDebug.history.empty': '暂无发送记录',
  ...
  'settings.enableRequestHistory': '开启请求发送历史（Debug 调试栏按接口记录最近发送，可应用到表单）',

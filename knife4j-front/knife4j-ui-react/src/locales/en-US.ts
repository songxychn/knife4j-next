const enUS = {
  ...
  "apiDoc.notFound.desc":
    "No OpenAPI operation matched the current route. Please reopen from the left API list.",
  ...
  "apiDoc.body.notExpandable":
    "Field expansion is not supported for this request body",
  ...
  "apiDoc.response.notExpandable":
    "Field expansion is not supported for this response",
  ...
  "apiDebug.tooltip.deprecated":
    "This parameter is deprecated but can still be filled",
  "apiDebug.tag.readOnly": "ReadOnly",
  "apiDebug.tooltip.readOnly":
    "ReadOnly parameters usually do not need to be sent by the client",
  ...
  "apiDebug.header.autoInject":
    "Content-Type is auto-injected by the selected Body type (visible in cURL on send)",
  ...
  "apiDebug.preview.bodyMultipart":
    "Body (multipart/form-data — file fields attached at send time)",
  ...
  "apiDebug.preview.autoContentType":
    "(Content-Type is auto-injected based on body type)",
  ...
  "auth.schemes.oauth2.accessToken.placeholder":
    "Paste access token or click Obtain Token",
  ...
  "apiDebug.auth.modal.title":
    "401 Unauthorized — please configure authentication",
  ...
  "officeDoc.alert.mockData":
    "Mock data or unloaded document detected; exported content may be incomplete.",
  ...
  // Settings page
  "settings.tip":
    "After enabling personalized settings, API tabs need to be closed and reopened or refresh the page",
  "settings.enableRequestCache":
    "Enable request parameter cache (Debug panel auto-caches last filled values)",
  "settings.enableDynamicParameter":
    "Enable dynamic parameters (Support dynamic injection in debug mode)",
  ...
  "settings.enableHost":
    "Override Host (Use specified Host to replace API BaseURL in debug mode)",
  ...
  // Footer settings
  "settings.footerEnabled": "Show Footer",
  "settings.footerCustomContent.placeholder":
    "Leave blank to show default copyright text",
  "settings.footerCustomContent.desc":
    "Custom footer content (leave blank to use the default copyright text)",
  "auth.modal401.title": "401 Unauthorized — Authentication Required",
  "auth.modal401.description":
    "The request was rejected with 401. Please configure your credentials below and resend.",

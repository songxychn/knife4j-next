const enUS = {
  ...
  'apiDebug.response.binaryHint': 'Binary response, cannot display as text',
  'apiDebug.response.download': 'Download File',
  'apiDebug.response.noBlob': 'No binary data',
  'apiDebug.response.emptyBody': 'Empty response body',

...
| 当前版本 | `4.5.0`（最后一个 Maven Central 发布版本） | `5.7.2` |
...
- **Patch**（`5.0.1`、`5.0.2`、`5.0.3`、`5.0.4`、`5.0.5`、`5.0.6`、`5.0.7`、`5.0.8`、`5.0.9`、`5.0.10`、`5.0.11`、`5.0.12`、`5.0.13`、`5.0.14`、`5.0.15`、`5.0.17`、`5.0.18`、`5.2.1`、`5.2.3`、`5.2.4`、`5.3.1`、`5.3.2`、`5.3.3`、`5.6.1`、`5.7.1`、`5.7.2`）：安全修复、Bug 修复与兼容体验改进。

...
This page describes the OpenAPI 3.1 contract of Java `5.7.2`. See the
...
`5.7.2` / Knife4x `v0.8.1` still ship the 3.1 contract on this page and keep 3.2 on a separate path.

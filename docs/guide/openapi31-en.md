...
This page describes the OpenAPI 3.1 contract of Java `5.7.0`. See the
...
`5.7.0` / Knife4x `v0.8.0` still ship the 3.1 contract on this page and keep 3.2 on a separate path.

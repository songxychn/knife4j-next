...
This page describes the OpenAPI 3.1 contract of Java `5.7.1`. See the
...
Existing OpenAPI 3.0.x behavior remains available. OpenAPI 3.2.x consumption is documented in the
[OpenAPI 3.2 support matrix](./openapi32-en); published
`5.7.1` / Knife4x `v0.8.1` still ship the 3.1 contract on this page and keep 3.2 on a separate path.
...
| OpenAPI 3.2.x | React | Published | Never guessed or treated as 3.1; see the [OpenAPI 3.2 matrix](./openapi32-en) |
...
| --- | --- | --- | --- |
| Single and multi-document loading | The entry document and controlled cross-document resources share one 3.1 parsing session | A 3.2 document does not enter the 3.1 workflow; 3.2 consumption is in the [3.2 matrix](./openapi32-en) | [#682](https://github.com/songxychn/knife4j-next/pull/682), [#689](https://github.com/songxychn/knife4j-next/pull/689), [#727](https://github.com/songxychn/knife4j-next/pull/727) |

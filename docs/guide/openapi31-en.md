...
This page describes the OpenAPI 3.1 contract of Java `5.7.5`. See the
...
`5.7.5` / Knife4x `v0.8.4` still ship the 3.1 contract on this page and keep 3.2 on a separate path.

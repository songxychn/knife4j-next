...
只有 `openapi: 3.0.x`、`openapi: 3.1.x` 或 `openapi: 3.2.x` JSON 可以继续用于已发布的 `v0.8.3`；入口不接受 YAML。
...
- spec 为 JSON；已发布版本顶层是 `openapi: 3.0.x`、`openapi: 3.1.x` 或合法 `openapi: 3.2.x`
